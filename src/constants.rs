...
pub(crate) const THE_HEAVENLY_STEMS: [&'static str; 10] =
    [
        "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"
    ];
...
pub(crate) const THE_EARTHLY_BRANCHES: [&'static str; 12] =
    [
...
pub(crate) const THE_ZODIAC_SIGNS: [[&'static str; 2]; 12] =
    [
        ["鼠", "鼠"],
        ["牛", "牛"],
        ["虎", "虎"],
...
pub(crate) const THE_LUNAR_YEARS: [&'static str; 60] =
    [
...
pub(crate) const THE_SOLAR_MONTHS: [&'static str; 12] =
    [
        "一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"
    ];

/// 列舉農曆十二個月份名稱：正月、二月、三月、四月、五月、六月、七月、八月、九月、十月、冬月、臘月。閏月緊接其後。
pub(crate) const THE_LUNAR_MONTHS: [[&'static str; 2]; 31] =
    [
        ["正月", "正月"],
        ["二月", "二月"],
        ["三月", "三月"],
...
pub(crate) const THE_SOLAR_DAYS: [&'static str; 31] =
    [
        "一", "二", "三", "四", "五", "六", "七", "八", "九", "十", // 10
        "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十", // 20
        "二十一", "二十二", "二十三", "二十四", "二十五", "二十六", "二十七", "二十八", "二十九", "三十", // 30
        "三十一"
    ];

/// 列舉農曆三十個天數名稱：初一、初二、...、十一、十二、...、廿一、廿二、...、三十。
pub(crate) const THE_LUNAR_DAYS: [&'static str; 30] =
    [
...
/// 列舉西曆年用到的數字：零、一、二、...、九。
pub(crate) const THE_SOLAR_YEAR_NUMBERS: [&'static str; 10] =
    [
        "零", "一", "二", "三", "四", "五", "六", "七", "八", "九"
    ];
...
/// 從正月到臘月共十二個月的八字重量。
pub(crate) const BA_ZI_WEIGHT_MONTHS: [u8; 12] =
    [
...
/// 從子時到亥時共十二地支的八字重量。
pub(crate) const BA_ZI_WEIGHT_TIME: [u8; 12] =
    [
